...
function insertIntoDb($responses) {
  try {
    ...
    foreach ($responses as $film) {
      $stmt = $conn->prepare("INSERT INTO movieslist (movie_DB_Id, vote_average, poster_path, backdrop_path, original_language, title, overview, release_date, genre_1, genre_2, genre_3) VALUES (:movie_DB_Id, :vote_average, :poster_path, :backdrop_path, :original_language, :title, :overview, :release_date, :genre_1, :genre_2, :genre_3)");
